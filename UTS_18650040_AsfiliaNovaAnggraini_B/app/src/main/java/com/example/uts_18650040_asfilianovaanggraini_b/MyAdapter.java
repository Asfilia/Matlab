...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView ) {
            ...
            simbol = (TextView) itemView.findViewById(R.id.simbol);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.nomor.setText(listItem.getNomor());
        holder.simbol.setText(listItem.getSimbol());
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                builder.setTitle(listItem.getSimbol());
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            case 0 :
                                ...
                                intent.putExtra("nomor",listItem.getNomor());
                                intent.putExtra("simbol",listItem.getSimbol());
                            ...
                            case 1 :
                                ...
                                intent2.putExtra("nomor",listItem.getNomor());
                                intent2.putExtra("simbol",listItem.getSimbol());
                            ...
                            case 2 :
                                ...
                                builderDel.setTitle(listItem.getSimbol());
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),"Successfully Deleted Data "+ listItem.getSimbol(),Toast.LENGTH_LONG).show();
