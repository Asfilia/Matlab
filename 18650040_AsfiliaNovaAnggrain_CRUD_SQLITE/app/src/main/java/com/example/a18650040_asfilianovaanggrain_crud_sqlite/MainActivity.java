...
import com.example.a18650040_asfilianovaanggrain_crud_sqlite.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabelBiodata.addView(barisTabel, new TableLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
        ArrayList<HashMap<String, String>> arrayListBiodata = sqLiteHelper.tampil_semua_biodata();
        if (arrayListBiodata.size() > 0) {
            for (int i = 0; i < arrayListBiodata.size(); i++) {
                ...
                tabelBiodata.addView(barisTabel, new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
            }
        }
    }
